  ...
  security: {
    ...
    sections: [
      { h: 'Our security posture', ul: [
        ...
        'What we do not have yet, stated plainly: multi-factor authentication, SSO/SAML, and customer-visible audit logs. None of those are built today — where the pricing page offers SSO or audit logs "on request", that means we will scope and build them with an Enterprise customer, not that they are waiting to be switched on. Self-service password reset is available, and changing or resetting a password revokes every session issued before it. We are not SOC 2 or ISO 27001 audited and do not claim to be.'
      ] },
